#!/usr/bin/env python
"""
fullstackopen documentation build configuration file.
...
src_path = os.path.abspath(os.path.join(docs_src_path, "..", "fullstackopen"))
sys.path.insert(0, src_path)
src_path = os.path.abspath(os.path.join(docs_src_path, ".."))
sys.path.insert(0, src_path)


import fullstackopen.core  # noqa
...
_full_version = fullstackopen.core.__version__
author = fullstackopen.core.__author__
copyright = fullstackopen.core.__copyright__
...
htmlhelp_basename = "fullstackopen-doc"
